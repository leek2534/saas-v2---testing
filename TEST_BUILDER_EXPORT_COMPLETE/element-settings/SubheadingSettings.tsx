...
interface SubheadingSettingsProps {
  node: { id: string; props: Record<string, any> };
  updateProps: (updates: any) => void;
}

const SUBHEADING_PRESETS = [
  {
    id: 'section-intro',
    name: 'Section Intro',
    description: 'Standard section subheading',
    props: {
  ...
  },
  {
    id: 'hero-subtitle',
    name: 'Hero Subtitle',
    description: 'Large hero section subtitle',
    props: {
      text: 'The Complete Solution for Modern Teams',
      level: 'h2',
      fontSize: 32,
      fontWeight: '500',
      lineHeight: 1.4,
  ...
  },
  {
    id: 'feature-label',
    name: 'Feature Label',
    description: 'Small feature section label',
    props: {
      text: 'Key Features',
      level: 'h4',
      fontSize: 18,
  ...
  {
    id: 'centered-support',
    name: 'Centered Support',
    description: 'Centered supporting text',
    props: {
  ...
  },
  {
    id: 'bold-statement',
    name: 'Bold Statement',
    description: 'Strong, bold subheading',
    props: {
...
export function SubheadingSettings({ node, updateProps }: SubheadingSettingsProps) {
  ...
  React.useEffect(() => {
    const defaults: any = {};
    if (!props.text) defaults.text = 'Your Subheading Here';
    if (!props.level) defaults.level = 'h3';
    if (!props.fontSize) defaults.fontSize = 24;
    if (!props.fontWeight) defaults.fontWeight = '600';
    if (!props.lineHeight) defaults.lineHeight = 1.3;
    if (!props.letterSpacing) defaults.letterSpacing = 0;
    if (!props.textColor) defaults.textColor = '#374151';
          ...
          <div className="mt-3 p-2 bg-primary/10 rounded-lg border border-blue-200 dark:border-blue-800">
            <div className="flex items-center justify-between">
              <p className="text-xs font-semibold text-blue-900 dark:text-blue-100">
                Current: {SUBHEADING_PRESETS.find(p => p.id === props.presetId)?.name || 'Custom'}
              </p>
          ...
          <SectionCard id="text" title="Text Content" icon={Type}>
            <div className="space-y-3">
              ...
              <div>
                ...
                <Select value={props.level || 'h3'} onValueChange={(value) => updateProps({ level: value })}>
