...
const TEXT_PRESETS = [
  {
    ...
    props: {
      text: 'This is standard body text that is easy to read and perfect for long-form content.',
      fontSize: 16,
      fontWeight: '400',
      lineHeight: 1.6,
      letterSpacing: 0,
  ...
  },
  {
    ...
    props: {
      text: 'This larger text works great for introductory paragraphs and important statements.',
      fontSize: 20,
      fontWeight: '400',
      lineHeight: 1.7,
      letterSpacing: 0,
  ...
  },
  {
    ...
    props: {
      text: 'Small caption text for images, footnotes, or supplementary information.',
      fontSize: 14,
      fontWeight: '400',
      lineHeight: 1.5,
      letterSpacing: 0,
  ...
  },
  {
    id: 'quote-emphasis',
    name: 'Quote Emphasis',
    description: 'Styled text for quotes',
    props: {
      text: '"This styled quote text draws attention and adds visual interest to important statements."',
      fontSize: 18,
      fontWeight: '500',
      lineHeight: 1.6,
      letterSpacing: 0.5,
  ...
  },
  {
    id: 'centered-lead',
    name: 'Centered Lead',
    description: 'Centered lead paragraph',
    props: {
      text: 'This centered lead text is perfect for hero sections and important announcements.',
      fontSize: 18,
      fontWeight: '400',
      lineHeight: 1.7,
      letterSpacing: 0,
...
export function TextSettings({ node, updateProps }: TextSettingsProps) {
  const props = node.props;
  const [activeTab, setActiveTab] = useState('content');
  const [searchQuery, setSearchQuery] = useState('');
  const [showPresetPicker, setShowPresetPicker] = useState(false);

  // Set default values ONLY on initial mount and ONLY if values are truly undefined
  // Don't override existing values - this prevents reverting user changes
  React.useEffect(() => {
    const defaults: any = {};
    if (props.text === undefined || props.text === null || props.text === '') {
      defaults.text = 'Your text content goes here...';
    }
    ...
    if (props.letterSpacing === undefined || props.letterSpacing === null) {
      defaults.letterSpacing = 0;
    }
    if (props.textColor === undefined || props.textColor === null) {
      defaults.textColor = '#4b5563';
    }
    ...
    // Only run once on mount - don't re-run on prop changes
          ...
          <div className="mt-3 p-2 bg-primary/10 rounded-lg border border-blue-200 dark:border-blue-800">
            <div className="flex items-center justify-between">
              <p className="text-xs font-semibold text-blue-900 dark:text-blue-100">
                Current: {TEXT_PRESETS.find(p => p.id === props.presetId)?.name || 'Custom'}
              </p>
              <button
